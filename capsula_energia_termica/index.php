    ...
    <div class="contInd">
      <div class="columns">
        <div class="column">
          ...
          <h1 class="titulo mostrar-web" style="color: #badde1">Cápsula de refuerzo de Energía Térmica </h1>
          <img src="assets/img/pastilla_termica.png" alt="" class="imgpastilla">

          <h1 class="titulo mostrar-mobile" style="color: #badde1">Cápsula de refuerzo de Energía Térmica </h1>
  ...
  <script>
    $( document ).ready(function() {
      $(".btn-enviar").on("click", function(){
        ...
        $.ajax({
          type: "POST",
          url: "../../functions_helpers.php?capsula_qr=energia_termica",
          dataType: "json",
          data:{
            nombre:nombre,
            cedula:cedula
