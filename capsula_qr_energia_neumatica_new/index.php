    ...
    <div class="contInd">
      <div class="columns">
        <div class="column">
          ...
          <h1 class="titulo mostrar-web" style="color: #badde1">Cápsula de refuerzo de Energía Neumática</h1>
          <img src="assets/img/pastilla_neumatica.png" alt="" class="imgpastilla">
          <h1 class="titulo mostrar-mobile" style="color: #badde1; line-height: 1.3em;">Cápsula de refuerzo de <br>Energía Neumática</h1>
  ...
  <script>
    $( document ).ready(function() {
      $(".btn-enviar").on("click", function(){
        ...
        $.ajax({
          type: "POST",
          url: "../../functions_helpers.php?capsula_qr=energia_neumatica",
          dataType: "json",
          data:{
            nombre:nombre,
            cedula:cedula
