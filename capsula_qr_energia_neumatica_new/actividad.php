					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div style="text-align:center;">
								...
								<button class="btn btn-reiniciar" onclick="reiniciarActividad($('#actividad_h_04'), [], 2,4)" style="background-color: #47a76d !important"> <i class="fas fa-sync"></i> Reiniciar</button>
								<br>
							</div>
							<div style="text-align:center;">
								<hr style="width: 80%; margin: 2% auto; border: 1px solid #8f8f8f">
