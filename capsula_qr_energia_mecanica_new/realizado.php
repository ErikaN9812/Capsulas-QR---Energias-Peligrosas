			...
			<div class="container dividerBg current">
				<div class="row mx-auto" style="max-width:1000px;">
					<div class="col-lg-6 col-md-12">
						<h1 style="text-align: center; color: #fff;">Gracias por tu interés</h1>
						<h1 style="color: #fff; text-align: center;">Esta actividad ya la has completado</h1>
						<p style="color: #fff; text-align: center;">Continúa buscando más códigos QR para seguir aprendiendo sobre las ENERGÍAS PELIGROSAS en tu operación</p>
						<!--<button class="btn mt-3s">Iniciar</button>-->
					</div>
					<div class="col-lg-6 col-md-12">
						<img class="imagencarlfin" src="assets/img/Carl_final.png">
					</div>
				</div>
			</div>
