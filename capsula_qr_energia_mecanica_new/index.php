    ...
    <div class="contInd">
      <div class="columns">
        <div class="column">
          ...
          <h1 class="titulo mostrar-web" style="color: #badde1">Cápsula de refuerzo de Energía Mecánica </h1>
          <img src="assets/img/pastilla_mecanica.png" alt="" class="imgpastilla">

          <h1 class="titulo mostrar-mobile" style="color: #badde1; line-height: 1.3em;">Cápsula de refuerzo de <br>Energía Mecánica </h1>
